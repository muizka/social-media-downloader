...
```bash
termux-setup-storage && pkg update -y && pkg upgrade -y && pkg install python ffmpeg git -y && git clone https://github.com && cd social-media-downloader && pip install --upgrade pip && pip install -r requirements.txt
```
